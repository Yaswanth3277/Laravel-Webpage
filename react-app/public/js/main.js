...
function optioncheck(){
    eemail = document.getElementById("signup-option").value;
    if(eemail == null || eemail == ""){
        document.getElementById("option-status").innerHTML = "*";
        document.getElementById("option-status").style.color="red";
    }
    else{
        document.getElementById("option-status").innerHTML = "*";
        document.getElementById("option-status").style.color="white";
    }
}
...
function visitorinsertview(){
    document.getElementById("vis-insert-form").style.display="block";
    document.getElementById("vis-update-form").style.display="none";
}

function visitorupdateview(){
    document.getElementById("vis-update-form").style.display="block";
    document.getElementById("vis-insert-form").style.display="none";
}

function poolinsertview(){
    document.getElementById("pool-insert-form").style.display="block";
    document.getElementById("pool-update-form").style.display="none";
}

function poolupdateview(){
    document.getElementById("pool-update-form").style.display="block";
    document.getElementById("pool-insert-form").style.display="none";
}

function gardeninsertview(){
    document.getElementById("garden-insert-form").style.display="block";
    document.getElementById("garden-update-form").style.display="none";
}

function gardenupdateview(){
    document.getElementById("garden-update-form").style.display="block";
    document.getElementById("garden-insert-form").style.display="none";
}

function servicesinsertview(){
    document.getElementById("services-insert-form").style.display="block";
    document.getElementById("services-update-form").style.display="none";
}

function servicesupdateview(){
    document.getElementById("services-update-form").style.display="block";
    document.getElementById("services-insert-form").style.display="none";
}
...
function uploadbutton(){
    const fileupload = document.getElementById("uploadbutton");
...
function emailValidation(){
    ...
    if(email == null || email == ""){
        document.getElementById("luser-status").innerHTML = "*";
        document.getElementById("luser-status").style.color="red";
    }
    else if(email.value.match(reg)){
        document.getElementById("luser-status").style.color="green"
        document.getElementById("luser-status").innerHTML = "Valid";
        return true;
    }
    else{
        document.getElementById("luser-status").style.color="red"
        document.getElementById("luser-status").innerHTML = "Invalid Email";
        return false;
    }
}
...
function emailcheck(){
    ...
    var regu = /^[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+@[a-zA-Z0-9-]+(?:\.[a-zA-Z0-9-]+)*$/;
    if(eemail == null || eemail == ""){
        document.getElementById("email-status").innerHTML = "*";
        document.getElementById("email-status").style.color="red";
    }
    else if(eemail.value.match(regu)){
        document.getElementById("email-status").style.color="green";
        document.getElementById("email-status").innerHTML = "Valid";
    }
    else{
        document.getElementById("email-status").innerHTML = "Invalid Email";
        document.getElementById("email-status").style.color="red";
    }
}
...
function contactemailCheck(){
    ...
    var creg = /^[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+@[a-zA-Z0-9-]+(?:\.[a-zA-Z0-9-]+)*$/;
    if(cemail == null || cemail == ""){
        document.getElementById("cemail-status").innerHTML = "*";
        document.getElementById("cemail-status").style.color="red";
    }
    else if(cemail.value.match(creg)){
        document.getElementById("cemail-status").style.color="green"
        document.getElementById("cemail-status").innerHTML = "Valid";
        return true;
    }
    else{
        document.getElementById("cemail-status").style.color="red"
        document.getElementById("cemail-status").innerHTML = "Invalid Email";
        return false;
    }
}

function contactphoneCheck(){
    var phone = document.getElementById("contactPhone");
    var preg = /^\d{10}$/;

    if(phone.value.match(preg)){
        document.getElementById("ccontact-status").innerHTML = "*";
    }
}
