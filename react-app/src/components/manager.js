...
class Manager extends Component {
    constructor(props){
        ...
        localStorage.setItem("winname", "Manager");
    }
    componentDidMount(){
	        ...
	        <div className="medium-12 columns">
                <div>
                    <div id="manleftbar">
                        ...
                        <h3>Manager</h3><br/>
                        <a id="managerlogout" href="/" onClick={e=>this.logout(e)}>Logout</a><br/><br/>
                        <ul>
                            <a href="#" onClick={window['manapartmentform']}><li id="firstbt">Apartments</li></a>
